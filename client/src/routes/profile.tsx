...
export const Route = createFileRoute("/profile")({
  head: () => ({ meta: [{ title: "Profile — GenWeb.ai" }, { name: "description", content: "Your GenWeb.ai profile." }] }),
  component: Profile,
});
        ...
        <div className="rounded-2xl border bg-card p-6">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">alex@genweb.ai · Pro plan</div>
          ...
          <form onSubmit={(e) => { e.preventDefault(); toast.success("Saved"); }} className="grid sm:grid-cols-2 gap-4 mt-8">
            ...
            <TextField size="small" label="Email" defaultValue="alex@genweb.ai" sx={{ gridColumn: "1 / -1" }} />
